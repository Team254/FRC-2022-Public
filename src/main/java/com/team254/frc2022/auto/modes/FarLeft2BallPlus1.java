...
public class FarLeft2BallPlus1 extends AutoModeBase {
    public FarLeft2BallPlus1() {
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        runAction(
                new ParallelAction(
                        ...
                        new DriveTrajectoryAction(TrajectoryGenerator.getInstance().getTrajectorySet().farLeftBall2ToFarLeftEject)
                )
        );
